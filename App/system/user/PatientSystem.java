...
/**
 * System class for managing Patient records.
 * Provides functionalities to load, retrieve, and export Patient data.
 */
public class PatientSystem extends UserSystem {

    /**
     * Constructs a PatientSystem and loads patients from the given CSV file.
     *
     * @param filePath          Path to the CSV file containing Patient data.
     * @param medicalRecordPath Path to the CSV file containing Medical BaseModel data.
     */
    public PatientSystem(String filePath, String medicalRecordPath) {
        super();
