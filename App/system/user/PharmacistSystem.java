...
/**
 * System class for managing Pharmacist records.
 * Provides functionalities to load, retrieve, and append Pharmacist data.
 */
public class PharmacistSystem extends StaffSystem {

    /**
     * Constructs a PharmacistSystem and loads Pharmacists from the given CSV file.
     *
     * @param filePath Path to the CSV file containing Pharmacist data.
     */
    public PharmacistSystem(String filePath) {
        super(filePath, "Pharmacist"); // Only import rows with userType "Pharmacist"
    }

    /**
     * Appends Pharmacist records to the CSV file by extending StaffSystem's functionality.
     *
