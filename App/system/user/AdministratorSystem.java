...
/**
 * System class for managing Administrator records.
 * Provides functionalities to load, retrieve, and append Administrator data.
 */
public class AdministratorSystem extends StaffSystem {

    /**
     * Constructs an AdministratorSystem and loads administrators from the given CSV file.
     *
     * @param filePath Path to the CSV file containing Administrator data.
     */
    public AdministratorSystem(String filePath) {
        super(filePath, "Administrator"); // Only import rows with userType "Administrator"
    }

    /**
     * Appends Administrator records to the CSV file by extending StaffSystem's functionality.
     *
