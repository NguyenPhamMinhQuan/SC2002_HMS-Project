...
/**
 * System class for managing appointment records.
 * Provides functionalities for loading, adding, removing, and exporting appointments.
 */
public class AppointmentSystem extends RecordSystem {

    /**
     * Constructs an AppointmentSystem and loads appointments from the given CSV file.
     *
     * @param appointmentsFilePath Path to the CSV file containing appointment records.
     */

    public AppointmentSystem(String appointmentsFilePath) {
        super();
    ...
    }// the appointment record id is the key of the appointment record in the hashmap, found relevant func in BaseModel.java
